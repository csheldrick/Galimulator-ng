import type { GalaxyState, StarSystem, Empire, Monster, MonsterKind, PRNG, SystemMarker, MarkerKind, Oddity, OddityKind } from "../types/sim";
...
export function spawnOddity(state: GalaxyState, rng: PRNG, forcedKind?: OddityKind): void {
  ...
  const kind = forcedKind ?? rng.pick(ODDITY_KINDS);
