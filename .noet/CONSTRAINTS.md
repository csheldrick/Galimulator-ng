...
- Sandbox empire IDs must be checked against state.empires before insertion. — Same-tick merges reduce map cardinality, so count-derived IDs can overwrite a live empire and corrupt ownership links.
